...
from livestream.views import load_correct_access_log_files, load_and_merge_files, get_listeners_in_interval, get_average_listening_time

class Command(BaseCommand):
    format = "Format: python manage.py averagetime 2014-01-01T00:00:00 2014-01-01T01:00:01"
    error = "Wrong date format. " + format
    help = "Get average listening time in interval. " + format
    args = "<dt dt>"
